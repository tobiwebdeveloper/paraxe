import { NuxtApp, useNuxtApp } from "../nuxt.js";
import { UseHeadInput } from "@unhead/vue/types";
//#region src/app/types/augments.d.ts
declare global {
  namespace NodeJS {
    interface Process {
...
type _NuxtAugmentsAnchor = NuxtApp;
//#endregion
export { _NuxtAugmentsAnchor };