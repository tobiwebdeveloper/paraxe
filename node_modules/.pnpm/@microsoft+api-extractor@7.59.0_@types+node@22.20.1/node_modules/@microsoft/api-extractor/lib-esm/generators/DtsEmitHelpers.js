    ...
    static modifyImportTypeSpan(collector, span, astDeclaration, modifyNestedSpan) {
        ...
        if (referencedEntity) {
            ...
            if (modulePath.startsWith('.')) {
                collector.messageRouter.addAnalyzerIssue(ExtractorMessageId.UnresolvedImportPath, `The inline import path "${modulePath}" could not be resolved, so it would be emitted unchanged` +
