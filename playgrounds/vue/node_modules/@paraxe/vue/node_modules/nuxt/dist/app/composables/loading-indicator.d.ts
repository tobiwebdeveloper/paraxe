...
//#region src/app/composables/loading-indicator.d.ts
 ...
 * @since 3.9.0
 */
declare function useLoadingIndicator(opts?: Partial<LoadingIndicatorOpts>): Omit<LoadingIndicator, '_cleanup'>;
//#endregion
export { LoadingIndicator, LoadingIndicatorOpts, useLoadingIndicator };